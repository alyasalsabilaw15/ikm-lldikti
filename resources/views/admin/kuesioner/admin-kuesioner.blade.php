                    ...
                    <div class="mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute" style="font-weight: 500; tzop: 6px; right: 12px; cursor: pointer; font-size: 18px; font-family: monospace; color: #9196a1;" onclick="resetDateFrom()">
                                    x
                                </div>
                            </div>
        ...
        <table id="table" class="table table-bordered table-hover" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th class="text-nowrap text-center">Perguruan Tinggi</th>
    ...
    function fetchData() {
        table = $('#table').DataTable({
            ...
            columns: [
                ...
                // {data: 'pt', class: 'text-nowrap'},
                {data: 'nilai', class: 'text-nowrap'},
                {data: 'email', class: 'text-nowrap'},
                // {data: 'nama_layanan', class: 'text-nowrap'},
                {data: 'pt', class: 'text-nowrap'},
