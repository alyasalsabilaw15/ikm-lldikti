...
class KuesionerController extends Controller
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        if ($request->jenis_layanan != null) {
            $tbl_setting = DB::table('tbl_setting')->where('id', $request->jenis_layanan)->first();
        }
        ...
        return Excel::download(new ExportExcelFromView(
            ...
            [
                ...
                'nama_layanan' => $request->jenis_layanan != null ? $tbl_setting->namalayanan . ' / ' . $tbl_setting->deskripsi : 'ALL',
                'date_from' => $request->date_from,
                'date_to' => $request->date_to,
